...
if __name__ == "__main__":
    ...
    # sensors = {1: ['left_thigh_front_1', 'emg'], 2: ['left_thigh_front_2', 'emg'],  3: ['left_thigh_back', 'emg'],
    #            4: ['left_shank_front', 'emg'], 5: ['left_shank_back', 'emg'], 6: ['right_thigh_front_1', 'emg'],
    #            7: ['right_thigh_front_2', 'emg'], 8: ['right_thigh_back', 'emg'], 9: ['right_shank_front', 'emg'],
    #            10: ['right_shank_back', 'emg']}

    # # more sensors on impaired leg (right)
    sensors = {1: ['left_thigh_front_1', 'both'],  2: ['left_thigh_back', 'both'],
              3: ['left_shank_front', 'both'], 4: ['left_shank_back', 'both'], 5: ['right_thigh_front_1', 'both'],
              6: ['right_thigh_front_2', 'both'], 7: ['right_thigh_back', 'both'], 8: ['right_shank_front', 'both'],
              9: ['right_shank_back', 'both'], 10: ['backpack', 'both']}

    #  no 6
    # sensors = {1: ['left_thigh_front_1', 'both'],  2: ['left_thigh_back', 'both'],
    #           3: ['left_shank_front', 'both'], 4: ['left_shank_back', 'both'], 5: ['right_thigh_front_1', 'both'],
    #           7: ['right_thigh_back', 'both'], 8: ['right_shank_front', 'both'],
    #           9: ['right_shank_back', 'both'], 10: ['backpack', 'both']}

    # sensors = {1: ['left_thigh_front', 'both'], 2: ['left_thigh_back', 'both']}
    # sensors = {1: ['left_thigh_front', 'both']}
    # sensors = {1: ['left_thigh_front', 'both'], 2: ['left_shank_front', 'both'], 3: ['right_thigh_front', 'both'], 4: ['right_shank_front', 'both'], 5: ['backpack', 'both']}
